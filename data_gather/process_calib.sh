...
calib_dvsmsg_bag=$1
output_dir=$2
topic=${3:-/grayscale_camera/image_raw}

# if fourth argument provided, else 0
GPU_ID=${4:-0}

echo "Processing calibration rosbag with dvs event msg type: $calib_dvsmsg_bag"
echo "Using image topic: $topic"
...
CUDA_VISIBLE_DEVICES=$GPU_ID python /home/anish1/e2calib/python/offline_reconstruction.py \
 --h5file $output_dir/events.h5 \
 --height 480 \
 --width 640 \
 --timestamps_file $output_dir/infrared1/timestamps.txt \
 --output $output_dir/reconstructions \
 --upsample_rate 1
...
python3 /home/anish1/evfly_ws/src/evfly/data_gather/images_to_bags.py \
 --image_folders $output_dir/reconstructions/e2calib $output_dir/infrared1 \
 --topics /cam0/image_raw /cam1/image_raw \
 --output_bag $output_dir/kalibr_rosbag.bag

# now enter kalibr docker and run calibration
echo "Running calibration in docker"
bash /home/anish1/evfly_ws/src/evfly/data_gather/run_kalibr.sh $output_dir
